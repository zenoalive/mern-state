...
export default function Search() {
    ...
    const onShowMoreClick = async (e) => {
        ...
        const startIndex = numberOfListings - 9
            ...
            <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
                <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
                    ...
                    <div className='flex gap-2 flex-wrap items-center'>
                        ...
                        <div className='flex gap-2'>
                            <input type='checkbox' id='sell' onChange={handleChange} checked={sidebardata.type === 'sell'} />
                            <span>Sell</span>
                        </div>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <select id='sort_order' className='border-rounded-lg p-' onChange={handleChange} defaultValue='created_at_desc'>
